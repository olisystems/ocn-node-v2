                ...
                class TariffsControllerTest(@Autowired val mockMvc: MockMvc) {
                    ...
                    fun `When GET sender tariffs return paginated tariffs list`() {
                        ...
                        val responseHeaders = HttpHeaders().apply {
                            this["Link"] = "https://node.ocn.co/ocpi/sender/2.2/tariffs/page/39; rel=\"next\""
                            this["X-Limit"] = "10"
                            this["X-Total-Count"] = "23"
                        }

                        every { requestHandlerBuilder.build<Array<Tariff>>(requestVariables) } returns mockRequestHandler

                        // Mock the forwardHaasAsync call to return the mockRequestHandler itself
                        every { mockRequestHandler.forwardHaasAsync() } returns mockRequestHandler
                    ...
                    fun `When GET sender Tariffs page should return proxied tariff list`() {
                        ...
                        val mockRequestHandler = mockk<OcpiRequestHandler<Array<Tariff>>>()
                        val responseHeaders = HttpHeaders().apply {
                            this["Link"] = "https://client.ocn.co/ocpi/sender/2.2/tariffs/page/40; rel=\"next\""
                            this["X-Limit"] = "10"
                        }
