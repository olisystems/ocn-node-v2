...
class CredentialsService(
    ...
    fun getCredentials(tokenC: String): OcpiResponse<Credentials> {
        return platformRepo.findByAuth_TokenC(tokenC)?.let {
            OcpiResponse(
    ...
    fun postCredentials(tokenA: String, body: Credentials): OcpiResponse<Credentials> {
        ...
        val platform = platformRepo.findByAuth_TokenA(tokenA)
        ...
        for (role in body.roles) {
            ...
            if (roleRepo.existsByCountryCodeAndPartyIDAllIgnoreCase(basicRole.country, basicRole.id)) {
                val existingRoles = roleRepo.findAllByCountryCodeAndPartyIDAllIgnoreCase(basicRole.country, basicRole.id)
    ...
    fun putCredentials(tokenC: String, body: Credentials): OcpiResponse<Credentials> {
        ...
        val platform = platformRepo.findByAuth_TokenC(tokenC)
            ?: throw OcpiClientInvalidParametersException("Invalid CREDENTIALS_TOKEN_C")
