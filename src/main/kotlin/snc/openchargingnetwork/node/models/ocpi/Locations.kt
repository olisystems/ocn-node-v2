...
@JsonInclude(JsonInclude.Include.NON_NULL)
data class Hours(
    @JsonProperty("twentyfourseven") val twentyfourseven: Boolean,
...
data class EnergyMix(
    @JsonProperty("is_green_energy") val isGreenEnergy: Boolean,
...
data class EnergySource(
    @JsonProperty("source") val source: EnergySourceCategory,
    @JsonProperty("percentage") val percentage: Float
)

data class EnvironmentalImpact(
    @JsonProperty("category") val category: EnvironmentalImpactCategory,
